...
rind::MissileBoss::MissileBoss(
    ...
    uint32_t& enemyCount
        ...
        setHealth(500.0f);
        setTransform(
            glm::scale(transform, glm::vec3(2.0f))
        );
...
void rind::MissileBoss::shoot() {
    ...
    Missile* missile = new Missile(
        ...
        bodyForward * 20.0f + glm::vec3(0.0f, verticalAim * 10.0f, 0.0f) + vel * 0.25f,
        getTrailColor(),
        6.0f
    );
