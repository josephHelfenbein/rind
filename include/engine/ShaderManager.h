    ...
    struct GraphicsShader {
        ...
        struct Config {
            ...
            struct InputBinding {
                ...
                std::function<VkDescriptorBufferInfo(engine::Renderer*, size_t frame)> bufferProvider{nullptr};
                std::function<void(engine::Renderer*, size_t frame, uint32_t count, std::vector<VkDescriptorImageInfo>& imageInfos)> imageArrayProvider{nullptr};
